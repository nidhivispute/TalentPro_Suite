								...
								?>
										<tbody>
											<tr>
												...
												<td <?php if ($row->Status == 1) { ?> <a href="goal-tracking.php?confirm=<?php echo htmlentities($row->id); ?>" onclick="return confirm('Do you really want to Un-Confirm the Goal?')">
												...
												<td>
													<p class="mb-1"><?php echo  "Completed " . htmlentities($row->Progress) . "%"; ?></p>
